...
class Config(object):
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://kota:kota@cluster0.pgtn9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
